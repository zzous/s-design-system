...
function rm(i, e, t) {
  ...
  function d() {
    ...
    function w(V) {
      const T = new ui(O), $ = Ta(V.anchor, p), C = Ta(V.origin, T);
      let {
        x: B,
        y: ee
      } = em($, C);
    ...
    for (; ; ) {
      ...
      {
        const C = ba(O, g);
        x.x = g.width - C.x.before - C.x.after, x.y = g.height - C.y.before - C.y.after, S += C.x.before, O.x += C.x.before, Q += C.y.before, O.y += C.y.before;
      }
      break;
    }
    const G = ya(v.anchor);
    return Object.assign(t.value, {
      ...
      maxWidth: pe(Ra(ua(x.x, o.value === 1 / 0 ? 0 : o.value, a.value))),
      maxHeight: pe(Ra(ua(x.y, l.value === 1 / 0 ? 0 : l.value, h.value)))
    }), {
      available: x,
      contentBox: O
    };
...
function mm(i, e) {
  ...
  const w = pa(), S = j(() => i.target === "cursor" && p.value ? p.value : w.value ? w.el : uf(i.target, r) || o.value), Q = j(() => Array.isArray(S.value) ? void 0 : S.value);
  let x;
...
const Cm = Ye({
  ...
  setup(i, e) {
    ...
    const r = mt("VOverlay"), o = F(), l = F(), a = F(), h = TO(i, "modelValue"), c = j({
      ...
      if (J) return J;
      const ze = ((Ki = w == null ? void 0 : w.value) == null ? void 0 : Ki.getRootNode()) || ((ha = (aa = r.proxy) == null ? void 0 : aa.$el) == null ? void 0 : ha.getRootNode());
    ...
    function ve(J) {
      var ze, Ki;
      J.key === "Escape" && y.value && (i.persistent ? Xe() : (c.value = !1, (ze = a.value) != null && ze.contains(document.activeElement) && ((Ki = w.value) == null || Ki.focus())));
    }
    const Re = FO();
    Or(() => i.closeOnBack, () => {
      HO(Re, (J) => {
    ...
    return rf(() => {
      var J;
      return q(Te, null, [(J = t.activator) == null ? void 0 : J.call(t, {
        isActive: c.value,
        targetRef: P,
        props: nt({
          ref: S
        }, E.value, i.activatorProps)
      }), C.value && p.value && q(ur, {
        disabled: !T.value,
        to: T.value
      }, {
        default: () => [q("div", nt({
    ...
    if (c.nodeType == 1) {
      ...
      if (n == "nearest" ? e.left < u.left ? (m = -(u.left - e.left + r), t > 0 && e.right > u.right + m && (m = e.right - u.right + m + r)) : e.right > u.right && (m = e.right - u.right + r, t < 0 && e.left < u.left + m && (m = -(u.left + m - e.left + r))) : m = (n == "center" ? e.left + (e.right - e.left) / 2 - (u.right - u.left) / 2 : n == "start" == l ? e.left - r : e.right - (u.right - u.left) + r) - u.left, m || y)
        if (d)
          ...
          if (y) {
            let w = c.scrollTop;
            c.scrollTop += y / O, v = (c.scrollTop - w) * O;
          }
          if (m) {
            let w = c.scrollLeft;
            c.scrollLeft += m / p, g = (c.scrollLeft - w) * p;
          }
          e = {
            left: e.left - g,
            top: e.top - v,
  ...
  updateChildren(e, t, n) {
    ...
    for (let o = s.length - 1; ; o--) {
      ...
      if (n && n.range.fromB < f && n.range.toB > c) {
        let w = bn.build(this.view.state.doc, c, n.range.fromB, this.decorations, this.dynamicDecorationMap), S = bn.build(this.view.state.doc, n.range.toB, f, this.decorations, this.dynamicDecorationMap);
        d = w.breakAtStart, p = w.openStart, O = S.openEnd;
        let Q = this.compositionView(n);
        S.breakAtStart ? Q.breakAfter = 1 : S.content.length && Q.merge(Q.length, Q.length, S.content[0], !1, S.openStart, 0) && (Q.breakAfter = S.content[0].breakAfter, S.content.shift()), w.content.length && Q.merge(0, 0, w.content[w.content.length - 1], !0, 0, w.openEnd) && w.content.pop(), u = w.content.concat(Q).concat(S.content);
      } else
...
function jo(i, e, t) {
  ...
  for (let p = i.firstChild; p; p = p.nextSibling) {
    ...
    for (let m = 0; m < O.length; m++) {
      let y = O[m];
      s && zr(s, y) && (y = nh(sh(y, s.bottom), s.top));
      let g = Dg(e, y), v = qg(t, y);
      if (g == 0 && v == 0)
        return p.nodeType == 3 ? rh(p, e, t) : jo(p, e, t);
      if (!n || o > v || o == v && r > g) {
        n = p, s = y, r = g, o = v;
        let w = v ? t < y.top ? -1 : 1 : g ? e < y.left ? -1 : 1 : 0;
        l = !w || (w > 0 ? m < O.length - 1 : m > 0);
      }
      g == 0 ? t > y.bottom && (!c || c.bottom < y.bottom) ? (a = p, c = y) : t < y.top && (!f || f.top > y.top) && (h = p, f = y) : c && zr(c, y) ? c = sh(c, y.bottom) : f && zr(f, y) && (f = nh(f, y.top));
    }
  }
...
function Ou(i, e, t, n = -1) {
  ...
  for (let w = i.viewState.heightOracle.textHeight / 2, S = !1; a = i.elementAtHeight(u), a.type != je.Text; )
  ...
  if (m && ((s = i.docView.nearest(m)) === null || s === void 0 ? void 0 : s.isEditable) != !1) {
    if (p.caretPositionFromPoint) {
      ...
      w && ({ offsetNode: y, offset: g } = w);
    } else if (p.caretRangeFromPoint) {
      let w = p.caretRangeFromPoint(c, f);
      w && ({ startContainer: y, startOffset: g } = w, (!i.contentDOM.contains(y) || L.safari && Vg(y, g, c) || L.chrome && Xg(y, g, c)) && (y = void 0));
    }
    y && (g = Math.min(Mt(y), g));
  }
...
class Sh {
  ...
  measure(e) {
    ...
    let h = 0, c = 0;
    if (l.width && l.height) {
      let { scaleX: w, scaleY: S } = Rf(t, l);
      (w > 5e-3 && Math.abs(this.scaleX - w) > 5e-3 || S > 5e-3 && Math.abs(this.scaleY - S) > 5e-3) && (this.scaleX = w, this.scaleY = S, h |= 8, o = a = !0);
    }
    ...
    if ((this.contentDOMWidth != g || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = l.width, this.editorHeight = e.scrollDOM.clientHeight, h |= 8), a) {
      ...
      if (s.mustRefreshForHeights(w) && (o = !0), o || s.lineWrapping && Math.abs(g - this.contentDOMWidth) > s.charWidth) {
        let { lineHeight: S, charWidth: Q, textHeight: x } = e.docView.measureTextSize();
        o = S > 0 && s.refresh(r, S, Q, x, g / Q, w), o && (e.docView.minWidth = 0, h |= 8);
      }
      O > 0 && m > 0 ? c = Math.max(O, m) : O < 0 && m < 0 && (c = Math.min(O, m)), bh();
      for (let S of this.viewports) {
        let Q = S.from == this.viewport.from ? w : e.docView.measureVisibleLineHeights(S);
  ...
  ensureLineGaps(e, t) {
    ...
    let l = [], a = (c, f, u, d) => {
      ...
      if (n) {
        ...
        let g = this.pixelViewport.left + y, v = this.pixelViewport.right + y, w, S;
        if (u != null) {
          let Q = os(f, u), x = ((v - g) / 2 + m) / O;
          w = Q - x, S = Q + x;
        } else
          w = (g - m) / O, S = (v + m) / O;
        d = rs(f, w), p = rs(f, S);
  ...
  updateLineGaps(e) {
    jr.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = D.set(e.map((t) => t.draw(this, this.heightOracle.lineWrapping))));
  }
  ...
  let t = /* @__PURE__ */ Object.create(null), n = /* @__PURE__ */ Object.create(null), s = (o, l) => {
    ...
    for (let y = 1; y < p.length; y++) {
      ...
      s(g, !0), d[g] || (d[g] = {
        ...
        stopPropagation: !1,
        run: [(v) => {
          let w = Nt = { view: v, prefix: g, scope: o };
          return setTimeout(() => {
            Nt == w && (Nt = null);
          }, L0), !0;
        }]
...
function D0(i, e, t) {
  ...
  {
    let S = O ? v(t.from, null, O) : w(d, !1), Q = m ? v(null, t.to, m) : w(p, !0), x = [];
    return (O || d).to < (m || p).from - (O && m ? 1 : 0) || d.widgetLineBreaks > 1 && S.bottom + i.defaultLineHeight / 2 < Q.top ? x.push(y(f, S.bottom, u, Q.top)) : S.bottom < Q.top && i.elementAtHeight((S.bottom + Q.top) / 2).type == je.Text && (S.bottom = Q.top = (S.bottom + Q.top) / 2), g(S).concat(x).concat(g(Q));
  }
  function y(S, Q, x, P) {
    return new jn(
      e,
  ...
  function g({ top: S, bottom: Q, horizontal: x }) {
    let P = [];
    for (let E = 0; E < x.length; E += 2)
      P.push(y(x[E], S, x[E + 1], Q));
    return P;
  }
  function v(S, Q, x) {
    let P = 1e9, E = -1e9, G = [];
    function V(C, B, ee, Oe, oe) {
      let ne = i.coordsAtPos(C, C == x.to ? -2 : 2), ve = i.coordsAtPos(ee, ee == x.from ? 2 : -2);
      ...
      if (C.to > T && C.from < $)
        for (let B = Math.max(C.from, T), ee = Math.min(C.to, $); ; ) {
          ...
          for (let oe of i.bidiSpans(Oe)) {
            ...
            if (ne >= ee)
              break;
            ve > B && V(Math.max(ne, B), S == null && ne <= T, Math.min(ve, ee), Q == null && ve >= $, oe.dir);
          }
          if (B = Oe.to + 1, B >= ee)
            break;
        }
    return G.length == 0 && V(T, S == null, $, Q == null, i.textDirection), { top: P, bottom: E, horizontal: G };
  }
  function w(S, Q) {
    let x = l.top + (Q ? S.top : S.bottom);
...
const Ir = /* @__PURE__ */ R.define({
  ...
  writeMeasure(i) {
    ...
    for (let l = 0; l < this.manager.tooltips.length; l++) {
      ...
      let Q = w ? f.top - m - p - y.y : f.bottom + p + y.y, x = v + O;
      if (h.overlap !== !0)
        for (let P of o)
          P.left < x && P.right > v && P.top < Q + m && P.bottom > Q && (Q = w ? P.top - m - 2 - p : P.bottom + p + 2);
      ...
      h.overlap !== !0 && o.push({ left: v, top: Q, right: x, bottom: Q + m }), c.classList.toggle("cm-tooltip-above", w), c.classList.toggle("cm-tooltip-below", !w), h.positioned && h.positioned(i.space);
    }
  }
  maybeMeasure() {
...
function V1(i) {
  ...
  function f(S, Q, x, P, E, G) {
    let { id: V, start: T, end: $, size: C } = l, B = c, ee = h;
    for (; C < 0; )
      if (l.next(), C == -1) {
        let Re = r[V];
        x.push(Re), P.push(T - S);
        return;
      } else if (C == -3) {
        h = V;
        return;
  ...
  function u(S, Q, x, P) {
    ...
    if (G) {
      ...
      x.push(new ii(T, E[2] - $, n)), P.push($ - S);
    }
  }
  function d(S, Q) {
    return (x, P, E) => {
      let G = 0, V = x.length - 1, T, $;
      if (V >= 0 && (T = x[V]) instanceof ye) {
        if (!V && T.type == S && T.length == E)
          return T;
        ($ = T.prop(W.lookAhead)) && (G = P[V] + T.length + $);
      }
      return O(S, x, P, E, G, Q);
    };
  }
  function p(S, Q, x, P, E, G, V, T, $) {
    let C = [], B = [];
    for (; S.length > P; )
      C.push(S.pop()), B.push(Q.pop() + x - E);
    S.push(O(n.types[V], C, B, G - E, T - G, $)), Q.push(E - x);
  }
  function O(S, Q, x, P, E, G, V) {
    if (G) {
    ...
    return new ye(S, Q, x, P, V);
  }
  function m(S, Q) {
    let x = l.fork(), P = 0, E = 0, G = 0, V = x.end - s, T = { size: 0, start: 0, skip: 0 };
    e: for (let $ = x.pos - S; x.pos > $; ) {
      let C = x.size;
      if (x.id == Q && C >= 0) {
        T.size = P, T.start = E, T.skip = G, G += 4, P += 4, x.next();
        continue;
      }
      let B = x.pos - C;
      if (C < 0 || B < $ || x.start < V)
        break;
      let ee = x.id >= o ? 4 : 0, Oe = x.start;
      for (x.next(); x.pos > B; ) {
        if (x.size < 0)
          if (x.size == -3)
            ee += 4;
  ...
  function y(S, Q, x) {
    let { id: P, start: E, end: G, size: V } = l;
    if (l.next(), V >= 0 && P < o) {
      let T = x;
      if (V > 4) {
        let $ = l.pos - (V - 4);
      ...
      Q[--x] = T, Q[--x] = G - S, Q[--x] = E - S, Q[--x] = P;
    } else V == -3 ? h = P : V == -4 && (c = P);
    return x;
  }
  let g = [], v = [];
  for (; l.pos > 0; )
    f(i.start || 0, i.bufferStart || 0, g, v, -1, 0);
  let w = (e = i.length) !== null && e !== void 0 ? e : g.length ? v[0] + g[0].length : 0;
  return new ye(a[i.topID], g.reverse(), v.reverse(), w);
}
  ...
  function d(p, O, m, y, g) {
    for (let v = m; v < y; ) {
      ...
      if (v == w + 1) {
        if (Q > c) {
          let x = p[w];
          d(x.children, x.positions, 0, x.children.length, O[w] + g);
          continue;
        }
        f.push(p[w]);
      } else {
        let x = O[v - 1] + p[v - 1].length - S;
        f.push(zl(i, p, O, w, v, S, x, null, a));
      }
      u.push(S + g - r);
    }
  }
...
class W1 {
  ...
  highlightRange(e, t, n, s, r) {
    ...
    if (u && u.overlay) {
      ...
      for (let m = 0, y = l; ; m++) {
        let g = m < u.overlay.length ? u.overlay[m] : null, v = g ? g.from + l : a, w = Math.max(t, y), S = Math.min(n, v);
        if (w < S && O)
          for (; e.from < S && (this.highlightRange(e, w, S, s, r), this.startSpan(Math.min(S, e.to), h), !(e.to >= v || !e.nextSibling())); )
            ;
        if (!g || v > n)
          break;
...
const Z = st.define, us = Z(), Bt = Z(), Bh = Z(Bt), Yh = Z(Bt), Yt = Z(), ds = Z(Yt), Ur = Z(Yt), xt = Z(), oi = Z(xt), vt = Z(), St = Z(), tl = Z(), sn = Z(tl), ps = Z(), b = {
  /**
  A comment.
  */
  comment: us,
...
class Bv {
  ...
  match(e) {
    ...
    if (t.length == 1) {
      let g = Ce(e, 0), v = rt(g), w = v == e.length ? 0 : -100;
      if (g != t[0]) if (g == n[0])
        w += -200;
      else
        return null;
    ...
    if (l < 0) {
      for (let g = 0, v = Math.min(e.length, 200); g < v && h < a; ) {
        let w = Ce(e, g);
        (w == t[h] || w == n[h]) && (s[h++] = g), g += rt(w);
      }
      if (h < a)
        return null;
    }
    let c = 0, f = 0, u = !1, d = 0, p = -1, O = -1, m = /[a-z]/.test(e), y = !0;
    for (let g = 0, v = Math.min(e.length, 200), w = 0; g < v && f < a; ) {
      let S = Ce(e, g);
      l < 0 && (c < a && S == t[c] && (r[c++] = g), d < a && (S == t[d] || S == n[d] ? (d == 0 && (p = g), O = g + 1, d++) : d = 0));
      let Q, x = S < 255 ? S >= 48 && S <= 57 || S >= 97 && S <= 122 ? 2 : S >= 65 && S <= 90 ? 1 : 0 : (Q = wl(S)) != Q.toLowerCase() ? 1 : Q != Q.toUpperCase() ? 2 : 0;
      (!g || x == 1 && m || w == 0 && x != 0) && (t[f] == S || n[f] == S && (u = !0) ? o[f++] = g : o.length && (y = !1)), w = x, g += rt(S);
    }
...
`) === $)
    ...
    }), x = ($) => s.value.dispatch(s.value.state.replaceSelection($)), P = ($) => s.value.dispatch({ selection: { anchor: $ } }), E = ($, C) => s.value.dispatch({ selection: { anchor: $, head: C } }), G = ($, C) => s.value.dispatch({
...
const Ck = /* @__PURE__ */ Ie(Ux, [["render", Hx]]), Kx = {
      ...
      return M(), _("div", {
        ...
        z("div", Zw, [
          i.hiddenHeader ? Pe("", !0) : (M(), _("div", Aw, [
            z("ul", Mw, [
              (M(!0), _(Te, null, ut(o.value, (w, S) => (M(), _("li", {
                key: "header-key--" + S,
          ...
          l.value.length ? (M(!0), _(Te, { key: 1 }, ut(l.value, (w, S) => (M(), _("ul", {
            key: "content-row--" + S,
              ...
              i.showExpand ? (M(), _("div", Tw, [
                re(O.$slots, "table-expand", {
                  ...
                  q(y, {
                    ...
                    onClick: Pi((Q) => p(w), ["stop", "prevent"])
                  }, null, 8, ["icon", "onClick"])
                ])
              ])) : Pe("", !0),
              (M(!0), _(Te, null, ut(o.value, (Q, x) => {
                var P, E;
                return M(), _("div", {
                  key: "content-row--" + S + "__col--" + x,
                  ...
                  re(O.$slots, `${Q.key}`, { item: w }, () => [
                    we(K(lt(t)(w[Q.key]) ? "-" : w[Q.key]), 1)
                  ])
                ], 6);
              }), 128)),
              w.showExpandRow ? (M(), _("div", Rw, [
  ...
  setup(i, { emit: e }) {
    const t = e, n = i, s = F([]), r = F(1), o = F(1), l = F([]), a = F([]), h = (g) => {
      ...
      if (n.search) {
        ...
        return n.items.filter(
          (w) => g.some((S) => w[S] ? typeof w[S] == typeof {} || typeof w[S] == typeof [] ? JSON.stringify(w[S]).indexOf(n.search) > -1 : w[S].toString().indexOf(n.search) > -1 : !1)
        );
      }
      return n.smartSearch.length ? n.items.filter((v) => n.smartSearch.some((S) => {
        var Q, x;
        return S.key === "undefinedTag" ? !((Q = v.tagList) != null && Q.length) : S.value ? S.type === "tag" && ((x = v.tagList) != null && x.length) ? v.tagList.some((E) => E.tagKey.toLowerCase() === S.key.toLowerCase() && E.tagValue.toLowerCase() === S.value.toLowerCase()) : S.type !== "tag" ? typeof v[S.key] == "object" ? JSON.stringify(v[S.key]).toLowerCase().indexOf(S.value.toLowerCase()) > -1 : typeof v[S.key] == "number" ? v[S.key].toString().indexOf(S.value) > -1 : v[S.key].toLowerCase().indexOf(S.value.toLowerCase()) > -1 : !1 : !0;
      })) : n.items;
    }), u = F(), d = j(() => {
      var g, v;
    ...
    return he(
      ...
      const w = I("v-tooltip"), S = I("v-pagination"), Q = I("v-data-table");
      return M(), fe(Q, {
          ...
          return [
            ...
            i.hideFooter ? Pe("", !0) : (M(), _("div", Xw, [
              q(S, {
                ...
                variant: "flat",
                "total-visible": 10,
                length: ((x = i.options) == null ? void 0 : x.pageCnt) || c.value
              }, null, 8, ["modelValue", "length"])
            ]))
          ];
        }),
        "expanded-row": X((x) => [
          re(g.$slots, "expanded-row", Fp(Hp(x)), void 0, !0)
        ]),
        _: 2
      }, [
        i.single ? {
          ...
          fn: X(() => [
            z("tr", null, [
              ...
              (M(!0), _(Te, null, ut(a.value, (x, P) => (M(), _("th", {
                key: P,
                class: De(["v-data-table__td v-data-table__th v-data-table__th--sortable v-data-table__th v-data-table__th--sortable", [`v-data-table-column--align-${x.align || "center"}`, `${!x.order || "v-data-table__th--sorted"}`]]),
                onClick: (E) => y(x)
              }, [
                z("div", Ew, [
                  we(K(x.title) + " ", 1),
                  z("i", {
                    class: De(["mdi v-icon notranslate v-theme--light v-icon--size-default v-data-table-header__sort-icon", {
                      "mdi-arrow-up": x.order === "asc" || !x.order,
                      "mdi-arrow-down": x.order === "desc"
                    }]),
                    "aria-hidden": "true"
                  }, null, 2)
                ])
        ...
        ut(i.headers, (x, P) => ({
          ...
          fn: X(({ item: E }) => [
            i.tooltip ? (M(), fe(w, {
              ...
              activator: X(({ props: G }) => [
                z("span", nt(G, { class: "d-inline-block text-truncate sp-table-column__text" }), K(E[x.key] || "-"), 17)
              ]),
              default: X(() => [
                z("span", null, K(E[x.key] || "-"), 1)
              ]),
              _: 2
            }, 1024)) : (M(), _("div", Dw, [
              re(g.$slots, `item.${x.key}`, { item: E }, () => [
                we(K(E[x.key] || "-"), 1)
              ], !0)
            ]))
          ])
        ...
        p.value ? {
          ...
          fn: X(({ item: x, isSelected: P, toggleSelect: E }) => [
        ...
        i.footers && Object.keys(i.footers).length ? {
          ...
          fn: X(() => [
            z("tr", null, [
              (M(!0), _(Te, null, ut(i.headers, (x, P) => (M(), _("th", {
                key: "foot__" + P,
                width: x.width,
                style: Vt({ textAlign: x.align || "start" })
              }, [
                i.customSlotFooter[x.key] ? re(g.$slots, `${x.key}_footer`, {
                  key: 0,
                  props: i.footers
                }, void 0, !0) : (M(), _(Te, { key: 1 }, [
                  we(K(i.footers[x.key]), 1)
                ], 64))
              ], 12, Vw))), 128))
            ])
          ]),
...
const Dk = /* @__PURE__ */ Ie(ek, [["render", ik]]), nk = { class: "s-title-area__content" }, sk = { class: "s-title-area__title" }, rk = {
  ...
  setup(i, { emit: e }) {
    ...
    return he(
      ...
      const u = I("v-select"), d = I("RouterLink"), p = I("v-list-item"), O = I("v-tooltip"), m = I("v-list-group"), y = I("v-list");
      return M(), _("div", ck, [
        z("div", fk, [
          z("a", {
            "href.stop": "#",
              ...
              (M(!0), _(Te, null, ut(i.menuPath.subMenus, (g) => (M(), fe(m, {
                ...
                activator: X(({ props: v }) => [
                  q(p, nt({ ref_for: !0 }, v, {
                    ...
                    !g.subMenus || g.subMenus.length === 0 ? {
                      name: "title",
                      fn: X(() => [
                        q(d, {
                          ...
                          default: X(() => [
                            we(K(g.menuName || g.menuNameKr), 1)
                          ]),
                          _: 2
                        }, 1032, ["to"])
                      ]),
                ...
                default: X(() => [
                  (M(!0), _(Te, null, ut(g.subMenus, (v, w) => {
                    var S, Q;
                    return M(), fe(p, {
                      key: w,
                      class: De(["s-navi-inner-menu", {
                        disabled: ((S = i.selectedProject) == null ? void 0 : S.projectId) <= 0 && v.dependency === "PROJECT",
                        active: ((Q = i.selectedProject) == null ? void 0 : Q.projectId) > 0 || v.dependency !== "PROJECT"
                      }]),
                      value: v.idx,
                      "active-class": "menu-active",
                      ...
                      title: X(() => {
                        var x;
                        return [
                          ((x = i.selectedProject) == null ? void 0 : x.projectId) > 0 ? (M(), fe(d, {
                            key: 0,
                            class: "s-navi-inner-menu-title",
                            to: v.menuUrl
                          }, {
                            default: X(() => [
                              we(K(v.menuName || v.menuNameKr), 1)
                            ]),
                            _: 2
                          }, 1032, ["to"])) : (M(), _("span", mk, [
                            we(K(v.menuName || v.menuNameKr) + " ", 1),
