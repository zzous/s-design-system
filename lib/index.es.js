import { Fragment as Te, reactive as yl, computed as j, watchEffect as Ni, toRefs as Xp, shallowRef as qt, warn as bl, getCurrentInstance as zp, inject as Si, provide as vl, defineComponent as jc, watch as he, onScopeDispose as Ot, effectScope as Sl, ref as F, toRaw as Bc, isRef as Yc, h as Ic, mergeProps as nt, TransitionGroup as _p, Transition as Nc, createVNode as D, unref as lt, toRef as Wc, Text as jp, nextTick as Vn, onMounted as Wi, readonly as Bp, onBeforeUnmount as Yp, Teleport as dr, withDirectives as Ip, vShow as Np, resolveDirective as Wp, useSlots as Gp, resolveComponent as I, openBlock as M, createBlock as fe, createSlots as pr, withCtx as V, createTextVNode as we, toDisplayString as K, renderSlot as re, mergeModels as Gc, useModel as Uc, createElementBlock as _, createCommentVNode as Pe, createElementVNode as X, renderList as ut, normalizeStyle as Vt, onUnmounted as Up, normalizeClass as De, withModifiers as Pi, toHandlers as Fp, normalizeProps as Hp, guardReactiveProps as Kp, createStaticVNode as Jp, withKeys as fa } from "vue";
const eO = {
  dark: !1,
  colors: {},
...
function Jc(i) {
  return i.map((e) => e.type === Te ? Jc(e.children) : e).flat();
}
function ui() {
...
function om(i, e, t) {
  ...
  he([i.target, i.contentEl], (p, O) => {
    let [m, g] = p, [b, x] = O;
    b && !Array.isArray(b) && u.unobserve(b), m && !Array.isArray(m) && u.observe(m), x && u.unobserve(x), g && u.observe(g);
  }, {
    immediate: !0
  }), Ot(() => {
    u.disconnect();
  ...
  function d() {
    ...
    function v(q) {
      const T = new di(O), Q = Ra(q.anchor, p), C = Ra(q.origin, T);
      let {
        x: B,
        y: ee
      } = tm(Q, C);
    ...
    for (; ; ) {
      ...
      S += q, w += T, O.x += q, O.y += T;
      {
        const C = ba(x.anchor), B = Q.x.before || Q.x.after, ee = Q.y.before || Q.y.after;
        let Oe = !1;
        if (["x", "y"].forEach((oe) => {
          if (oe === "x" && B && !$.x || oe === "y" && ee && !$.y) {
            ...
            (Re[oe].before <= Q[oe].before && Re[oe].after <= Q[oe].after || Re[oe].before + Re[oe].after < (Q[oe].before + Q[oe].after) / 2) && (x = ne, Oe = $[oe] = !0);
          }
        }), Oe) continue;
      }
      Q.x.before && (S += Q.x.before, O.x += Q.x.before), Q.x.after && (S -= Q.x.after, O.x -= Q.x.after), Q.y.before && (w += Q.y.before, O.y += Q.y.before), Q.y.after && (w -= Q.y.after, O.y -= Q.y.after);
      {
        const C = va(O, b);
        P.x = b.width - C.x.before - C.x.after, P.y = b.height - C.y.before - C.y.after, S += C.x.before, O.x += C.x.before, w += C.y.before, O.y += C.y.before;
      }
      break;
    }
    const U = ba(x.anchor);
    return Object.assign(t.value, {
      ...
      top: pe(Dr(w)),
      left: i.isRtl.value ? void 0 : pe(Dr(S)),
      right: i.isRtl.value ? pe(Dr(-S)) : void 0,
      minWidth: pe(U === "y" ? Math.min(o.value, p.width) : o.value),
      maxWidth: pe(La(da(P.x, o.value === 1 / 0 ? 0 : o.value, a.value))),
      maxHeight: pe(La(da(P.y, l.value === 1 / 0 ? 0 : l.value, h.value)))
    }), {
      available: P,
      contentBox: O
    };
...
function gm(i, e) {
  ...
  const v = Oa(), S = j(() => i.target === "cursor" && p.value ? p.value : v.value ? v.el : pf(i.target, r) || o.value), w = j(() => Array.isArray(S.value) ? void 0 : S.value);
  let P;
...
const Zm = Ye({
  ...
  setup(i, e) {
    ...
    function ve(J) {
      var ze, Ki;
      J.key === "Escape" && g.value && (i.persistent ? Xe() : (c.value = !1, (ze = a.value) != null && ze.contains(document.activeElement) && ((Ki = v.value) == null || Ki.focus())));
    }
    const Re = HO();
    mr(() => i.closeOnBack, () => {
      KO(Re, (J) => {
    ...
    return (e, t) => {
      ...
      return M(), _("div", Vm, [
        D(n, {
          ...
          default: V(() => [
            i.title ? (M(), _("div", Xm, K(i.title), 1)) : Pe("", !0),
...
class de extends H {
  ...
  decompose(e, t, n, s) {
    let r = e <= 0 && t >= this.length ? this : new de(Va(this.text, e, t), Math.min(t, this.length) - Math.max(0, e));
    if (s & 1) {
  ...
  replace(e, t, n) {
    ...
    [e, t] = qi(this, e, t);
    let s = ws(this.text, ws(n.text, Va(this.text, 0, e)), t), r = this.length + n.length - (t - e);
...
class N {
  ...
  */
  static create(e = {}) {
    let t = Vs.resolve(e.extensions || [], /* @__PURE__ */ new Map()), n = e.doc instanceof H ? e.doc : H.of((e.doc || "").split(t.staticFacet(N.lineSeparator) || go)), s = e.selection ? e.selection instanceof k ? e.selection : k.single(e.selection.anchor, e.selection.head) : k.single(0);
  ...
  for (let c = i, f = !1; c && !f; )
    if (c.nodeType == 1) {
      ...
      if (s == "nearest")
        ...
        g = (s == "center" && b <= x ? e.top + b / 2 - x / 2 : s == "start" || s == "center" && t < 0 ? e.top - o : e.bottom - x + o) - u.top;
      }
      if (n == "nearest" ? e.left < u.left ? (m = -(u.left - e.left + r), t > 0 && e.right > u.right + m && (m = e.right - u.right + m + r)) : e.right > u.right && (m = e.right - u.right + r, t < 0 && e.left < u.left + m && (m = -(u.left + m - e.left + r))) : m = (n == "center" ? e.left + (e.right - e.left) / 2 - (u.right - u.left) / 2 : n == "start" == l ? e.left - r : e.right - (u.right - u.left) + r) - u.left, m || g)
        if (d)
          ...
          if (g) {
            let v = c.scrollTop;
            c.scrollTop += g / O, x = (c.scrollTop - v) * O;
          }
          if (m) {
            let v = c.scrollLeft;
  ...
  updateChildren(e, t, n) {
    ...
    for (let o = s.length - 1; ; o--) {
      ...
      if (n && n.range.fromB < f && n.range.toB > c) {
        ...
        let w = this.compositionView(n);
        S.breakAtStart ? w.breakAfter = 1 : S.content.length && w.merge(w.length, w.length, S.content[0], !1, S.openStart, 0) && (w.breakAfter = S.content[0].breakAfter, S.content.shift()), v.content.length && w.merge(0, 0, v.content[v.content.length - 1], !0, 0, v.openEnd) && v.content.pop(), u = v.content.concat(w).concat(S.content);
      } else
      ...
      let { i: m, off: g } = r.findPos(h, 1), { i: b, off: x } = r.findPos(a, -1);
      jf(this, b, x, m, g, u, d, p, O);
    }
...
function Bo(i, e, t) {
  ...
  for (let p = i.firstChild; p; p = p.nextSibling) {
    ...
    for (let m = 0; m < O.length; m++) {
      ...
      let b = qg(e, g), x = Vg(t, g);
      if (b == 0 && x == 0)
        return p.nodeType == 3 ? oh(p, e, t) : Bo(p, e, t);
      if (!n || o > x || o == x && r > b) {
        n = p, s = g, r = b, o = x;
        let v = x ? t < g.top ? -1 : 1 : b ? e < g.left ? -1 : 1 : 0;
        l = !v || (v > 0 ? m < O.length - 1 : m > 0);
      }
...
function gu(i, e, t, n = -1) {
  ...
  for (let v = i.viewState.heightOracle.textHeight / 2, S = !1; a = i.elementAtHeight(u), a.type != je.Text; )
  ...
  if (m && ((s = i.docView.nearest(m)) === null || s === void 0 ? void 0 : s.isEditable) != !1) {
    if (p.caretPositionFromPoint) {
      ...
      v && ({ offsetNode: g, offset: b } = v);
    } else if (p.caretRangeFromPoint) {
      let v = p.caretRangeFromPoint(c, f);
      v && ({ startContainer: g, startOffset: b } = v, (!i.contentDOM.contains(g) || L.safari && Xg(g, b, c) || L.chrome && zg(g, b, c)) && (g = void 0));
    }
    g && (b = Math.min(Mt(g), b));
  }
  if (!g || !i.docView.dom.contains(g)) {
    ...
    ({ node: g, offset: b } = Bo(v.dom, c, f));
  }
  let x = i.docView.nearest(g);
  if (!x)
    return null;
  if (x.isWidget && ((r = x.dom) === null || r === void 0 ? void 0 : r.nodeType) == 1) {
    let v = x.dom.getBoundingClientRect();
    return e.y < v.top || e.y <= v.bottom && e.x <= (v.left + v.right) / 2 ? x.posAtStart : x.posAtEnd;
  } else
...
class xh {
  ...
  updateScaler() {
    let e = this.scaler;
    return this.scaler = this.heightMap.height <= 7e6 ? wh : new ql(this.heightOracle, this.heightMap, this.viewports), e.eq(this.scaler) ? 0 : 2;
  }
  updateViewportLines() {
  ...
  measure(e) {
    ...
    if ((this.contentDOMWidth != b || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = l.width, this.editorHeight = e.scrollDOM.clientHeight, h |= 8), a) {
      ...
      if (s.mustRefreshForHeights(v) && (o = !0), o || s.lineWrapping && Math.abs(b - this.contentDOMWidth) > s.charWidth) {
        let { lineHeight: S, charWidth: w, textHeight: P } = e.docView.measureTextSize();
        o = S > 0 && s.refresh(r, S, w, P, b / w, v), o && (e.docView.minWidth = 0, h |= 8);
      }
      ...
      for (let S of this.viewports) {
        ...
        this.heightMap = (o ? Be.empty().applyChanges(this.stateDeco, H.empty, this.heightOracle, [new at(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(s, 0, o, new O0(S.from, w));
      }
      ji && (h |= 2);
    }
  ...
  ensureLineGaps(e, t) {
    ...
    let l = [], a = (c, f, u, d) => {
      ...
      if (n) {
        ...
        if (O > 2e6)
          for (let w of e)
            w.from >= c.from && w.from < c.to && w.size != w.displaySize && w.from * this.heightOracle.charWidth + g < this.pixelViewport.left && (g = w.size - w.displaySize);
        let b = this.pixelViewport.left + g, x = this.pixelViewport.right + g, v, S;
        if (u != null) {
          let w = os(f, u), P = ((x - b) / 2 + m) / O;
          v = w - P, S = w + P;
        } else
          v = (b - m) / O, S = (x + m) / O;
        d = rs(f, v), p = rs(f, S);
...
class ql {
  ...
  eq(e) {
    return e instanceof ql ? this.scale == e.scale && this.viewports.length == e.viewports.length && this.viewports.every((t, n) => t.from == e.viewports[n].from && t.to == e.viewports[n].to) : !1;
  }
}
function un(i, e) {
  if (e.scale == 1)
...
A.styleModule = cn;
A.inputHandler = ru;
A.clipboardInputFilter = Ml;
A.clipboardOutputFilter = Tl;
A.scrollHandler = hu;
A.focusChangeEffect = ou;
A.perLineTextDirection = lu;
A.exceptionSink = su;
A.updateListener = jo;
A.editable = It;
A.mouseSelectionStyle = nu;
A.dragMovesSelection = iu;
A.clickAddsSelectionRange = tu;
A.decorations = $n;
A.outerDecorations = uu;
A.atomicRanges = Ll;
A.bidiIsolatedRanges = du;
A.scrollMargins = pu;
A.darkTheme = No;
A.cspNonce = /* @__PURE__ */ R.define({ combine: (i) => i.length ? i[0] : "" });
A.contentAttributes = Rl;
A.editorAttributes = fu;
...
const R0 = /* @__PURE__ */ ri.default(/* @__PURE__ */ A.domEventHandlers({
  keydown(i, e) {
  ...
  let t = /* @__PURE__ */ Object.create(null), n = /* @__PURE__ */ Object.create(null), s = (o, l) => {
    ...
    for (let g = 1; g < p.length; g++) {
      ...
      s(b, !0), d[b] || (d[b] = {
        ...
        stopPropagation: !1,
        run: [(x) => {
          let v = Nt = { view: x, prefix: b, scope: o };
          return setTimeout(() => {
            Nt == v && (Nt = null);
          }, E0), !0;
        }]
...
function Tu(i, e, t, n) {
  Uo = e;
  let s = lg(e), r = Ce(s, 0), o = rt(r) == s.length && s != " ", l = "", a = !1, h = !1, c = !1;
...
function q0(i, e, t) {
  ...
  {
    let S = O ? x(t.from, null, O) : v(d, !1), w = m ? x(null, t.to, m) : v(p, !0), P = [];
    return (O || d).to < (m || p).from - (O && m ? 1 : 0) || d.widgetLineBreaks > 1 && S.bottom + i.defaultLineHeight / 2 < w.top ? P.push(g(f, S.bottom, u, w.top)) : S.bottom < w.top && i.elementAtHeight((S.bottom + w.top) / 2).type == je.Text && (S.bottom = w.top = (S.bottom + w.top) / 2), b(S).concat(P).concat(b(w));
  }
  function g(S, w, P, $) {
    return new jn(
      e,
  ...
  function b({ top: S, bottom: w, horizontal: P }) {
    let $ = [];
    for (let z = 0; z < P.length; z += 2)
      $.push(g(P[z], S, P[z + 1], w));
    return $;
  }
  function x(S, w, P) {
    let $ = 1e9, z = -1e9, U = [];
    function q(C, B, ee, Oe, oe) {
      let ne = i.coordsAtPos(C, C == P.to ? -2 : 2), ve = i.coordsAtPos(ee, ee == P.from ? 2 : -2);
      ...
      if (C.to > T && C.from < Q)
        for (let B = Math.max(C.from, T), ee = Math.min(C.to, Q); ; ) {
          ...
          for (let oe of i.bidiSpans(Oe)) {
            ...
            if (ne >= ee)
              break;
            ve > B && q(Math.max(ne, B), S == null && ne <= T, Math.min(ve, ee), w == null && ve >= Q, oe.dir);
          }
          if (B = Oe.to + 1, B >= ee)
            break;
        }
    return U.length == 0 && q(T, S == null, Q, w == null, i.textDirection), { top: $, bottom: z, horizontal: U };
  }
  function v(S, w) {
    let P = l.top + (w ? S.top : S.bottom);
...
class X0 {
  ...
  draw(e) {
    if (e.length != this.drawn.length || e.some((t, n) => !V0(t, this.drawn[n]))) {
...
const j0 = /* @__PURE__ */ ri.highest(/* @__PURE__ */ A.theme(Fo)), Vu = /* @__PURE__ */ Y.define({
  map(i, e) {
...
function h1(i) {
  ...
  return A.mouseSelectionStyle.of((t, n) => e(n) ? a1(t, n) : null);
}
const c1 = {
  Alt: [18, (i) => !!i.altKey],
...
}), Lh = /* @__PURE__ */ new WeakMap(), Vl = /* @__PURE__ */ ue.fromClass(class {
  constructor(i) {
  ...
  writeMeasure(i) {
    ...
    for (let l = 0; l < this.manager.tooltips.length; l++) {
      ...
      if (S < m && h.resize !== !1) {
        ...
        Lh.set(h, m), c.style.height = (m = S) / r + "px";
      } else c.style.height && (c.style.height = "");
      let w = v ? f.top - m - p - g.y : f.bottom + p + g.y, P = x + O;
      if (h.overlap !== !0)
        for (let $ of o)
          $.left < P && $.right > x && $.top < w + m && $.bottom > w && (w = v ? $.top - m - 2 - p : $.bottom + p + 2);
      if (this.position == "absolute" ? (c.style.top = (w - i.parent.top) / r + "px", c.style.left = (x - i.parent.left) / s + "px") : (c.style.top = w / r + "px", c.style.left = x / s + "px"), d) {
        let $ = f.left + (b ? g.x : -g.x) - (x + 14 - 7);
        d.style.left = $ / s + "px";
      }
      h.overlap !== !0 && o.push({ left: x, top: w, right: P, bottom: w + m }), c.classList.toggle("cm-tooltip-above", v), c.classList.toggle("cm-tooltip-below", !v), h.positioned && h.positioned(i.space);
    }
  }
  maybeMeasure() {
...
class g1 {
  ...
  get tooltip() {
    let e = this.view.plugin(Vl), t = e ? e.manager.tooltips.findIndex((n) => n.create == Sr.create) : -1;
...
const k1 = /* @__PURE__ */ ue.fromClass(class {
  constructor(i) {
    ...
    this.fixed = !i.state.facet(qh), this.fixed && (this.dom.style.position = "sticky"), this.syncGutters(!1), i.scrollDOM.insertBefore(this.dom, i.contentDOM);
  }
  update(i) {
    ...
    i.geometryChanged && (this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px"), this.view.state.facet(qh) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : ""), this.prevViewport = i.view.viewport;
  }
  syncGutters(i) {
...
class Xh {
  constructor(e, t) {
    ...
    this.markers = Vh(t.markers(e)), t.initialSpacer && (this.spacer = new Iu(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
  }
  update(e) {
    let t = this.markers;
...
function Uu(i) {
  ...
  return n ? s[e] = n : s.splice(e, 1), new q1(s, t);
}
class q1 {
  constructor(e, t) {
...
function X1(i) {
  ...
  function f(S, w, P, $, z, U) {
    ...
    let Oe = a[q], oe, ne, ve = T - S;
    if (Q - T <= s && (ne = m(l.pos - w, z))) {
      let Re = new Uint16Array(ne.size - ne.skip), Ve = l.pos - ne.size, Xe = Re.length;
      for (; l.pos > Ve; )
        Xe = g(ne.start, Re, Xe);
      oe = new ni(Re, Q - ne.start, n), ve = ne.start - S;
    } else {
      let Re = l.pos - C;
      l.next();
      let Ve = [], Xe = [], Et = q >= o ? q : -1, jt = 0, J = Q;
      for (; l.pos > Re; )
      ...
      if (Et >= 0 && jt > 0 && jt < Ve.length && p(Ve, Xe, T, jt, T, J, Et, B, ee), Ve.reverse(), Xe.reverse(), Et > -1 && jt > 0) {
        let ze = d(Oe, ee);
        oe = jl(Oe, Ve, Xe, 0, Ve.length, 0, Q - T, ze, ze);
      } else
        oe = O(Oe, Ve, Xe, Q - T, B - Q, ee);
    }
    P.push(oe), $.push(ve);
  }
  function u(S, w, P, $) {
    ...
    for (; l.pos > w; ) {
      ...
      if (B > 4)
        ...
        if (q > -1 && Q < q)
          break;
        q < 0 && (q = C - s), z.push(T, Q, C), U++, l.next();
      }
    }
    if (U) {
      let T = new Uint16Array(U * 4), Q = z[z.length - 2];
      for (let C = z.length - 3, B = 0; C >= 0; C -= 3)
        T[B++] = z[C], T[B++] = z[C + 1] - Q, T[B++] = z[C + 2] - Q, T[B++] = B;
      P.push(new ni(T, z[2] - Q, n)), $.push(Q - S);
    }
  }
  function d(S, w) {
    return (P, $, z) => {
      let U = 0, q = P.length - 1, T, Q;
      if (q >= 0 && (T = P[q]) instanceof ye) {
        if (!q && T.type == S && T.length == z)
          return T;
  ...
  function p(S, w, P, $, z, U, q, T, Q) {
    let C = [], B = [];
    for (; S.length > $; )
      C.push(S.pop()), B.push(w.pop() + P - z);
    S.push(O(n.types[q], C, B, U - z, T - U, Q)), w.push(z - P);
  }
  function O(S, w, P, $, z, U, q) {
    if (U) {
    ...
    return new ye(S, w, P, $, q);
  }
  function m(S, w) {
    let P = l.fork(), $ = 0, z = 0, U = 0, q = P.end - s, T = { size: 0, start: 0, skip: 0 };
    e: for (let Q = P.pos - S; P.pos > Q; ) {
      let C = P.size;
      if (P.id == w && C >= 0) {
        T.size = $, T.start = z, T.skip = U, U += 4, $ += 4, P.next();
        continue;
      }
      let B = P.pos - C;
    ...
    return (w < 0 || $ == S) && (T.size = $, T.start = z, T.skip = U), T.size > 4 ? T : void 0;
  }
  function g(S, w, P) {
    let { id: $, start: z, end: U, size: q } = l;
    if (l.next(), q >= 0 && $ < o) {
      let T = P;
      if (q > 4) {
        let Q = l.pos - (q - 4);
  ...
  let v = (e = i.length) !== null && e !== void 0 ? e : b.length ? x[0] + b[0].length : 0;
  return new ye(a[i.topID], b.reverse(), x.reverse(), v);
}
  ...
  function d(p, O, m, g, b) {
    for (let x = m; x < g; ) {
      ...
      if (x == v + 1) {
        ...
        let P = O[x - 1] + p[x - 1].length - S;
        f.push(jl(i, p, O, v, x, S, P, null, a));
      }
      u.push(S + b - r);
    }
  }
...
class G1 {
  ...
  highlightRange(e, t, n, s, r) {
    ...
    if (u && u.overlay) {
      ...
      for (let m = 0, g = l; ; m++) {
        let b = m < u.overlay.length ? u.overlay[m] : null, x = b ? b.from + l : a, v = Math.max(t, g), S = Math.min(n, x);
        if (v < S && O)
          for (; e.from < S && (this.highlightRange(e, v, S, s, r), this.startSpan(Math.min(S, e.to), h), !(e.to >= x || !e.nextSibling())); )
            ;
        if (!b || x > n)
          break;
...
function Nl(i, e) {
  let t = [Py], n;
  return i instanceof In && (i.module && t.push(A.styleModule.of(i.module)), n = i.themeType), e != null && e.fallback ? t.push(dd.of(i)) : n ? t.push(nl.computeN([A.darkTheme], (s) => s.facet(A.darkTheme) == (n == "dark") ? [i] : [])) : t.push(nl.of(i)), t;
}
class Qy {
  constructor(e) {
...
const qy = /* @__PURE__ */ Object.create(null), Uh = [Ke.none], Fh = [], Hh = /* @__PURE__ */ Object.create(null), Vy = /* @__PURE__ */ Object.create(null);
for (let [i, e] of [
...
const $d = (i) => Pd(i, !qe(i)), Cd = (i) => Pd(i, qe(i));
function Zd(i, e) {
  return yt(i, (t) => t.empty ? i.moveByGroup(t, e) : Qr(t, e));
}
const nb = (i) => Zd(i, !qe(i)), sb = (i) => Zd(i, qe(i));
function rb(i, e, t) {
  if (e.type.prop(t))
    return !0;
  let n = e.to - e.from;
...
const ob = (i) => yt(i, (e) => Pr(i.state, e, !qe(i))), lb = (i) => yt(i, (e) => Pr(i.state, e, qe(i)));
function Ad(i, e) {
  return yt(i, (t) => {
    if (!t.empty)
      return Qr(t, e);
...
const ab = (i) => yt(i, (e) => oi(i, e, !0)), hb = (i) => yt(i, (e) => oi(i, e, !1)), cb = (i) => yt(i, (e) => oi(i, e, !qe(i))), fb = (i) => yt(i, (e) => oi(i, e, qe(i))), ub = (i) => yt(i, (e) => k.cursor(i.lineBlockAt(e.head).from, 1)), db = (i) => yt(i, (e) => k.cursor(i.lineBlockAt(e.head).to, -1));
function pb(i, e, t) {
...
const Dd = (i) => Ed(i, !qe(i)), qd = (i) => Ed(i, qe(i));
function Vd(i, e) {
  return ct(i, (t) => i.moveByGroup(t, e));
}
const mb = (i) => Vd(i, !qe(i)), gb = (i) => Vd(i, qe(i)), yb = (i) => ct(i, (e) => Pr(i.state, e, !qe(i))), bb = (i) => ct(i, (e) => Pr(i.state, e, qe(i)));
function Xd(i, e) {
...
const Db = ({ state: i, dispatch: e }) => Wd(i, e, !1), qb = ({ state: i, dispatch: e }) => Wd(i, e, !0);
function Gd(i, e, t) {
  if (i.readOnly)
    return !1;
  let n = [];
...
const Vb = ({ state: i, dispatch: e }) => Gd(i, e, !1), Xb = ({ state: i, dispatch: e }) => Gd(i, e, !0), zb = (i) => {
  if (i.state.readOnly)
    return !1;
...
const Bb = ({ state: i, dispatch: e }) => {
  ...
  { key: "Shift-Alt-ArrowUp", run: Vb },
  { key: "Alt-ArrowDown", run: qb },
...
function fl(i) {
  ...
  function s() {
    ...
    i.dispatch({
      effects: [nr.of(!1), A.scrollIntoView(O.from, { y: "center" })],
      selection: O
    }), i.focus();
  }
  return { dom: n };
...
function Pv(i, e) {
  return (t, n, s, r) => ((r > t || r + s.length < n) && (r = Math.max(0, t - 2), s = i.sliceString(r, Math.min(i.length, n + 2))), (e(sr(s, t - r)) != ce.Word || e(rr(s, t - r)) != ce.Word) && (e(rr(s, n - r)) != ce.Word || e(sr(s, n - r)) != ce.Word));
}
class $v extends dp {
  constructor(e) {
    super(e);
...
function Cv(i) {
  return (e, t, n) => !n[0].length || (i(sr(n.input, n.index)) != ce.Word || i(rr(n.input, n.index)) != ce.Word) && (i(rr(n.input, n.index + n[0].length)) != ce.Word || i(sr(n.input, n.index + n[0].length)) != ce.Word);
}
class Zv extends dp {
  nextMatch(e, t, n) {
...
class Yv {
  ...
  match(e) {
    ...
    if (t.length == 1) {
      let b = Ce(e, 0), x = rt(b), v = x == e.length ? 0 : -100;
      if (b != t[0]) if (b == n[0])
        v += -200;
      else
        return null;
    ...
    for (let b = 0, x = Math.min(e.length, 200), v = 0; b < x && f < a; ) {
      ...
      let w, P = S < 255 ? S >= 48 && S <= 57 || S >= 97 && S <= 122 ? 2 : S >= 65 && S <= 90 ? 1 : 0 : (w = Ql(S)) != w.toLowerCase() ? 1 : w != w.toUpperCase() ? 2 : 0;
      (!b || P == 1 && m || v == 0 && P != 0) && (t[f] == S || n[f] == S && (u = !0) ? o[f++] = b : o.length && (g = !1)), v = P, b += rt(S);
    }
...
}), cS = typeof navigator == "object" && /* @__PURE__ */ /Win/.test(navigator.platform), fS = /* @__PURE__ */ ri.highest(/* @__PURE__ */ A.domEventHandlers({
  keydown(i, e) {
...
const xS = /* @__PURE__ */ A.domEventHandlers({
  mousedown(i, e) {
...
const kS = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), QS = /* @__PURE__ */ A.inputHandler.of((i, e, t, n) => {
  ...
  let n = $p(i, i.selection.main.head).brackets || qn.brackets, s = null, r = i.changeByRange((o) => {
    if (o.empty) {
      ...
      for (let a of n)
        if (a == l && Ar(i.doc, o.head) == Pp(Ce(a, 0)))
          return {
...
function CS(i, e) {
  ...
  for (let s of n) {
    let r = Pp(Ce(s, 0));
    if (e == s)
      return r == s ? TS(i, s, n.indexOf(s + s + s) > -1, t) : AS(i, s, r, t.before || qn.before);
...
function TS(i, e, t, n) {
  let s = n.stringPrefixes || qn.stringPrefixes, r = null, o = i.changeByRange((l) => {
    ...
    if (h == e) {
      ...
      if (i.charCategorizer(a)(h) != ce.Word && wc(i, a, s) > -1 && !RS(i, a, e, s))
        return {
          changes: { insert: e + e, from: a },
          effects: fi.of(a + e.length),
          range: k.cursor(a + e.length)
 ...
 */
const qS = (i) => i ? Object.entries(i).reduce((e, [t, n]) => (t = t.charAt(0).toUpperCase() + t.slice(1), t = `on${t}`, { ...e, [t]: n }), {}) : {};
function kc(i, e = {}, t) {
  const { props: n, domProps: s, on: r, ...o } = e, l = r ? qS(r) : {};
  return Ic(
    i,
    { ...o, ...n, ...s, ...l },
    t
...
const VS = (i) => typeof i == "function" ? i() : i;
var XS = jc({
  /** Component Name */
  name: "CodeMirror",
  /** Model Definition */
...
`) === Q)
      ...
      ), Q = t.value.childNodes[0].innerText.trim()), s.value = new A({
        parent: t.value,
    ...
    const u = () => {
    ...
    }, p = (Q, C) => s.value.state.sliceDoc(Q, C), O = (Q) => s.value.state.doc.line(Q + 1).text, m = () => s.value.state.doc.lines, g = () => s.value.state.selection.main.head, b = () => {
      let Q;
      ...
      (Q) => !Q.empty
    ), w = (Q, C, B) => s.value.dispatch({
      changes: { from: C, to: B, insert: Q }
    }), P = (Q) => s.value.dispatch(s.value.state.replaceSelection(Q)), $ = (Q) => s.value.dispatch({ selection: { anchor: Q } }), z = (Q, C) => s.value.dispatch({ selection: { anchor: Q, head: C } }), U = (Q, C) => s.value.dispatch({
...
const Vp = /* @__PURE__ */ "break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield".split(" ").map(qp), Rx = /* @__PURE__ */ Vp.concat(/* @__PURE__ */ ["declare", "implements", "private", "protected", "public"].map(qp));
function Lc(i = {}) {
  let e = i.jsx ? i.typescript ? Tx : Mx : i.typescript ? Ax : Oi, t = i.typescript ? Px.concat(Rx) : Tp.concat(Vp);
  return new K1(e, [
    Oi.data.of({
...
}), qx = "#e5c07b", Dc = "#e06c75", Vx = "#56b6c2", Xx = "#ffffff", Ls = "#abb2bf", gl = "#7d8799", zx = "#61afef", _x = "#98c379", qc = "#d19a66", jx = "#c678dd", Bx = "#21252b", Vc = "#2c313a", Xc = "#282c34", fo = "#353a42", Yx = "#3E4451", zc = "#528bff", Ix = /* @__PURE__ */ A.theme({
  "&": {
    color: Ls,
    backgroundColor: Xc
  },
...
const Ck = /* @__PURE__ */ Ie(Ux, [["render", Hx]]), Kx = {
  ...
  setup(i, { emit: e }) {
    const { isEmpty: t } = Cw, n = i, s = e, r = F(1), o = j(() => n.headers.filter((O) => O.key !== n.itemTitle)), l = F([]), a = j(() => {
      if (typeof n.search == typeof [])
        return n.search.length === 0 ? n.datas : n.datas.filter((m) => n.search.some((b) => {
          var x, v;
          return b.key === "undefinedTag" ? !((x = m.tagList) != null && x.length) : `${b.value}` ? b.type === "tag" && ((v = m.tagList) != null && v.length) ? m.tagList.some((w) => `${w.tagKey}`.toLowerCase() === `${b.key}`.toLowerCase() && `${w.tagValue}`.toLowerCase() === `${b.value}`.toLowerCase()) : b.type !== "tag" ? typeof m[b.key] == typeof {} || typeof m[b.key] == typeof [] ? `${JSON.stringify(m[b.key])}`.toLowerCase().indexOf(`${b.value}`.toLowerCase()) > -1 : `${m[b.key]}`.toLowerCase().indexOf(`${b.value}`.toLowerCase()) > -1 : !1 : !0;
        }));
      if (n.search) {
    ...
    return he(
      ...
      const g = I("v-btn"), b = I("empty"), x = I("v-pagination");
      return M(), _("div", {
        ...
        X("div", Zw, [
          i.hiddenHeader ? Pe("", !0) : (M(), _("div", Aw, [
            X("ul", Mw, [
              (M(!0), _(Te, null, ut(o.value, (v, S) => (M(), _("li", {
                key: "header-key--" + S,
          ...
          l.value.length ? (M(!0), _(Te, { key: 1 }, ut(l.value, (v, S) => (M(), _("ul", {
            key: "content-row--" + S,
              ...
              i.showExpand ? (M(), _("div", Tw, [
                re(O.$slots, "table-expand", {
                  ...
                  D(g, {
                    ...
                    onClick: Pi((w) => p(v), ["stop", "prevent"])
                  }, null, 8, ["icon", "onClick"])
                ])
              ])) : Pe("", !0),
              (M(!0), _(Te, null, ut(o.value, (w, P) => {
                var $, z;
                return M(), _("div", {
                  key: "content-row--" + S + "__col--" + P,
                  class: De(["s-card-table__body-wrapper", { "strong-text": (z = ($ = i.options) == null ? void 0 : $.strongs) == null ? void 0 : z.includes(w.key) }]),
                  style: Vt({
                    width: d.value(w.width),
                    justifyContent: w.align === "d-none" ? "center" : w.align || "center"
                  })
                }, [
                  re(O.$slots, `${w.key}`, { item: v }, () => [
                    we(K(lt(t)(v[w.key]) ? "-" : v[w.key]), 1)
                  ])
                ], 6);
              }), 128)),
              v.showExpandRow ? (M(), _("div", Rw, [
  ...
  setup(i, { emit: e }) {
    ...
    const o = F([]), l = F([]), a = (O) => {
      ...
      return n.smartSearch.length ? n.items.filter((m) => n.smartSearch.some((b) => {
        var x, v;
        return b.key === "undefinedTag" ? !((x = m.tagList) != null && x.length) : b.value ? b.type === "tag" && ((v = m.tagList) != null && v.length) ? m.tagList.some((w) => w.tagKey.toLowerCase() === b.key.toLowerCase() && w.tagValue.toLowerCase() === b.value.toLowerCase()) : b.type !== "tag" ? typeof m[b.key] == "object" ? JSON.stringify(m[b.key]).toLowerCase().indexOf(b.value.toLowerCase()) > -1 : typeof m[b.key] == "number" ? m[b.key].toString().indexOf(b.value) > -1 : m[b.key].toLowerCase().indexOf(b.value.toLowerCase()) > -1 : !1 : !0;
      })) : n.items;
    }), f = F(), u = (O) => {
      t("update:page", O);
    }, d = (O) => {
    ...
    return he(
      ...
      const g = I("v-tooltip"), b = I("v-pagination"), x = I("v-data-table");
      return M(), fe(x, {
        ...
        "column.data-table-select": V(({ column: v, selectAll: S }) => [
          re(O.$slots, "column.data-table-select", {
            column: v,
            selectAll: S
          }, void 0, !0)
        ]),
        "item.data-table-select": V(({ internalItem: v, isSelected: S, toggleSelect: w }) => [
        ...
        i.single ? {
          ...
          fn: V(() => [
            X("tr", null, [
              ...
              (M(!0), _(Te, null, ut(l.value, (v, S) => (M(), _("th", {
                key: S,
        ...
        ut(i.headers, (v, S) => ({
          ...
          fn: V(({ item: w }) => [
            i.tooltip ? (M(), fe(g, {
              ...
              activator: V(({ props: P }) => [
                X("span", nt(P, { class: "d-inline-block text-truncate sp-table-column__text" }), K(w[v.key] || "-"), 17)
              ]),
              default: V(() => [
                X("span", null, K(w[v.key] || "-"), 1)
              ]),
              _: 2
            }, 1024)) : (M(), _("div", Dw, [
              re(O.$slots, `item.${v.key}`, { item: w }, () => [
                we(K(w[v.key] || "-"), 1)
              ], !0)
            ]))
          ])
        ...
        i.footers && Object.keys(i.footers).length ? {
          ...
          fn: V(() => [
            X("tr", null, [
              (M(!0), _(Te, null, ut(i.headers, (v, S) => (M(), _("th", {
                key: "foot__" + S,
                width: v.width,
...
}, Lk = /* @__PURE__ */ Ie(zw, [["__scopeId", "data-v-3bd59205"]]), _w = {}, jw = {
  width: "190",
  height: "33",
  viewBox: "0 0 190 33",
  fill: "none",
      ...
      return M(), _(Te, null, [
        ...
        X("div", {
          ...
          X("div", Fw, [
            ...
            X("div", Kw, [
              (M(!0), _(Te, null, ut(i.serviceMenus, (g, b) => (M(), _(Te, null, [
                g.accessible ? (M(), fe(m, {
                  key: b,
                  class: "side-menu",
  ...
  setup(i, { emit: e }) {
    ...
    return he(
      ...
      return M(), _("div", ck, [
        ...
        X("div", Ok, [
          i.menuPath && i.menuPath.subMenus && i.menuPath.subMenus.length ? (M(), fe(g, {
            key: 0,
            opened: o.value,
            ...
            default: V(() => [
              (M(!0), _(Te, null, ut(i.menuPath.subMenus, (b) => (M(), fe(m, {
                key: b.idx,
                value: b.idx
              }, {
                activator: V(({ props: x }) => [
                ...
                default: V(() => [
                  (M(!0), _(Te, null, ut(b.subMenus, (x, v) => {
                    var S, w;
                    return M(), fe(p, {
                      key: v,
                      class: De(["s-navi-inner-menu", {
                        disabled: ((S = i.selectedProject) == null ? void 0 : S.projectId) <= 0 && x.dependency === "PROJECT",
                        active: ((w = i.selectedProject) == null ? void 0 : w.projectId) > 0 || x.dependency !== "PROJECT"
                      }]),
                      value: x.idx,
                      "active-class": "menu-active",
                      ...
                      title: V(() => {
                        var P;
                        return [
                          ((P = i.selectedProject) == null ? void 0 : P.projectId) > 0 ? (M(), fe(d, {
                            key: 0,
                            class: "s-navi-inner-menu-title",
                            to: x.menuUrl
                          }, {
