  ...
  <div class="view-wrapper">
    ...
    <div class="contents">
      <div class="mt-2">
        ...
        <v-btn class="mr-1" :active-color="btnActiveColor" base-color="#E4E6EF" variant="flat" to="branch">
          브랜치
        </v-btn>
        <v-btn class="mr-1" :active-color="btnActiveColor" base-color="#E4E6EF" variant="flat" to="merge-request">
          병합 요청
        </v-btn>
      </div>
      <router-view />
...
<script setup>
import ListViewHeaderComponent from '@/components/_common/ViewHeaderComponent.vue'
