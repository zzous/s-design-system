...
//import { UserMenuItems } from '@/data/paths'
//import { menuNameLang } from '@/i18n'
import * as _ from 'lodash-es'
import { GET_ACCESSIBLE_MENU, GET_ACCESSIBLE_TREE_MENU, GET_TREE_MENU } from '@/assets/consts/api/portal/menu'
...
export const useMenuStore = defineStore('menu', () => {
  ...
  const getAccessibleMenu = async () => {
    const { data } = await axios.get(GET_TREE_MENU + '?clientId=devops')
